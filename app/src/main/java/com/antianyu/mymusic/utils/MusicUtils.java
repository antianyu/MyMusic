...
public class MusicUtils {
    ...
    public static Music findPreviousMusic(List<Music> musicList, Music currentMusic) {
    ...
    public static Music findNextMusic(List<Music> musicList, Music currentMusic) {
        if (musicList.isEmpty()) {
            return new Music();
        } else {
            int chosenPosition = musicList.indexOf(currentMusic);
