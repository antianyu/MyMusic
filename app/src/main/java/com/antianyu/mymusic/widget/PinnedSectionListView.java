...
package com.antianyu.mymusic.widget;
...
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
        ...
        // measure & layout
        int ws =
            MeasureSpec.makeMeasureSpec(getWidth() - getListPaddingLeft() - getListPaddingRight(), MeasureSpec.EXACTLY);
    ...
    void ensureShadowForPosition(int sectionPosition, int firstVisibleItem, int visibleItemCount) {
        ...
        if (nextPosition < getCount()) {
            int nextSectionPosition =
                findFirstVisibleSectionPosition(nextPosition, visibleItemCount - (nextPosition - firstVisibleItem));
    ...
    protected void dispatchDraw(@NonNull Canvas canvas) {
        ...
        if (mPinnedSection != null) {
            ...
            int clipHeight =
                view.getHeight() + (mShadowDrawable == null ? 0 : Math.min(mShadowHeight, mSectionsDistanceY));
    ...
    public boolean dispatchTouchEvent(@NonNull MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN && mTouchTarget == null && mPinnedSection != null && isPinnedViewTouched(
            mPinnedSection.view, x, y)) { // create touch target
